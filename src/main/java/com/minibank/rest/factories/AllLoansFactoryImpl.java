...
{
    private Loan convert(com.minibank.core.events.loans.domain.Loan fromLoan)
    {
    ...
    private LoanExtension convert(com.minibank.core.events.loans.domain.LoanExtension
                                          fromLoanExtension)
    {
    ...
    public  AllLoans getNewAllLoans(AllLoansDetails allLoansDetails)
    {
        ...
        for(com.minibank.core.events.loans.domain.Loan fromLoan: allLoansDetails.getLoans())
        {
            Loan toLoan = convert(fromLoan);
            List<LoanExtension> toLoanExtensions = new ArrayList<>();

            for(com.minibank.core.events.loans.domain.LoanExtension fromLoanExtension:
